    ...
    var initChat = function (parentEl) {
        ...
        KTUtil.scrollInit(messageListEl, {
            ...
            height: function () {  // calculate height
                ...
                if (portletHeadEl) {
                    height = height + 100 - parseInt(KTUtil.css(portletHeadEl, 'height'));
                    height = height + 100 - parseInt(KTUtil.css(portletHeadEl, 'margin-top')) - parseInt(KTUtil.css(portletHeadEl, 'margin-bottom'));
                }

                if (portletBodyEl) {
                    height = height - 40 - parseInt(KTUtil.css(portletBodyEl, 'margin-top')) - parseInt(KTUtil.css(portletBodyEl, 'margin-bottom'));
                    height = height - 40 - parseInt(KTUtil.css(portletBodyEl, 'padding-top')) - parseInt(KTUtil.css(portletBodyEl, 'padding-bottom'));
                }

                if (portletFootEl) {
                    height = height - 40 - parseInt(KTUtil.css(portletFootEl, 'height'));
                    height = height - 40 - parseInt(KTUtil.css(portletFootEl, 'margin-top')) - parseInt(KTUtil.css(portletFootEl, 'margin-bottom'));
                }
